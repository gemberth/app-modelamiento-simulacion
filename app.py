...
def printNumerosAleatorios():
    return render_template('numerosaleatorios.html')

@app.route('/modelospronosticos')
def printModelosDePronosticos():
    return render_template('modelospronosticos.html')

@app.route('/regresiones')
def printRegresiones():
    return render_template('regresiones.html')

@app.route('/modelossimulacion')
def printModelosSimulacion():
    return render_template('modelossimulacion.html')
